...
export default function Home() {
  ...
  const handleConfirmBooking = async (data) => {
    ...
    const emailBody = `
      ...
      <h3>Questions?</h3>
      <p>Contact us on WhatsApp: +52 446 479 5085</p>
    ...
    try {
      ...
      const managementEmailBody = `
        ...
        ${data.dock_fee > 0 ? `<p><strong>Note:</strong> A separate dock fee of $${data.dock_fee.toLocaleString()} ${data.currency || 'MXN'} must be paid in cash upon arrival.</p>` : ''}
  ...
  if (step === 'landing') {
    return (
      <div className="min-h-screen">
        ...
        {/* Footer */}
        <footer className="relative text-white py-8 overflow-hidden" style={{ background: 'linear-gradient(to bottom, #061428, #020a14)' }}>
          <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 text-center">
            <motion.div
              ...
              className="mb-8"
            >
              <h3 className="text-3xl md:text-4xl font-light mb-3">Ready for your <span className="font-semibold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500">adventure?</span></h3>
              <p className="text-white/70 text-lg mb-8">Book now and create unforgettable memories</p>
              <div className="flex flex-col items-center gap-6 mb-8">
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                  <a 
                    ...
                    className="group inline-flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-pink-500/20 to-purple-500/20 hover:from-pink-500/30 hover:to-purple-500/30 rounded-2xl border border-pink-400/30 transition-all duration-300 hover:scale-105"
                  >
                    ...
                    <span className="font-medium text-white/90">@filumarine</span>
                  </a>
                  
                  <a 
                    href="https://wa.me/524464795085?text=Hello!%20I'm%20interested%20in%20booking%20a%20boat%20experience%20with%20Filu%20Marine." 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="group inline-flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-emerald-500/20 to-green-500/20 hover:from-emerald-500/30 hover:to-green-500/30 rounded-2xl border border-emerald-400/30 transition-all duration-300 hover:scale-105"
                  >
                    ...
                    <span className="font-medium text-white/90">+52 446 479 5085</span>
                  </a>
                </div>
                
                <div className="bg-white/5 backdrop-blur-md rounded-2xl p-6 border border-white/10">
                  <p className="text-white/60 text-sm mb-3 text-center">Scan to chat on WhatsApp</p>
                  <img 
            ...
            <div className="mt-12 pt-8 border-t border-white/10">
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <Link 
                  ...
                  className="group inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-cyan-500/20 to-blue-500/20 hover:from-cyan-500/30 hover:to-blue-500/30 rounded-xl border border-cyan-400/30 text-sm transition-all duration-300 hover:scale-105 font-medium text-white/90"
                >
                  <svg className="h-4 w-4 text-cyan-400 group-hover:text-cyan-300 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                >
                  <Settings className="h-4 w-4 text-white/60 group-hover:text-white/90 transition-colors" />
                  Admin Panel
                </Link>
              </div>
            </div>
  ...
  if (step === 'boat_selector') {
    return (
      <div className="relative min-h-screen" style={{ backgroundImage: `url('https://media.base44.com/images/public/6987f0afff96227dd3af0e68/c6ed2e8cf_FILUMarine2.png')`, backgroundRepeat: 'repeat', backgroundSize: '300px 300px', backgroundColor: '#0d1e3d' }}>
        <div className="absolute inset-0 pointer-events-none" style={{ background: 'rgba(5,15,35,0.72)' }} />
