...
export default function IntroSection() {
  return (
    <section className="relative py-6 md:py-10 overflow-hidden" style={{ background: '#0a1f3d' }}>
      <div className="absolute inset-0" style={{ backgroundImage: 'url(https://media.base44.com/images/public/6987f0afff96227dd3af0e68/1f9d0f41f_FILUMarine2.png)', backgroundRepeat: 'repeat', backgroundSize: '220px', opacity: 0.25 }} />
