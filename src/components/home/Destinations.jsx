  ...
  cancun: [
    {
      id: 'zona-hotelera',
      name: 'Zona Hotelera',
      description: 'Iconic hotel strip with turquoise Caribbean waters and white sand beaches.',
      image: 'https://images.unsplash.com/photo-1552074284-5e88ef1aef18?w=800',
    },
    {
      id: 'isla-mujeres',
      name: 'Isla Mujeres',
      description: 'Charming island reachable by ferry, famous for snorkeling with whale sharks.',
      image: 'https://images.unsplash.com/photo-1596402184320-417e7178b2cd?w=800',
    },
    {
      id: 'contoy-island',
      name: 'Isla Contoy',
      description: 'Pristine uninhabited bird sanctuary with spectacular coral reefs.',
      image: 'https://images.unsplash.com/photo-1544551763-77ef2d0cfc6c?w=800',
    },
    {
      id: 'playa-delfines',
      name: 'Playa Delfines',
      description: 'Scenic public beach with stunning open-sea views and consistent surf breaks.',
      image: 'https://images.unsplash.com/photo-1510414842594-a61c69b5ae57?w=800',
    },
    {
      id: 'nizuc',
      name: 'Nizuc Reef',
      description: 'Vibrant coral reef teeming with tropical fish, perfect for snorkeling and diving.',
      image: 'https://images.unsplash.com/photo-1583212292454-1fe6229603b7?w=800',
    },
    {
      id: 'puerto-morelos',
      name: 'Puerto Morelos',
      description: 'Tranquil fishing village with a protected national marine park reef nearby.',
