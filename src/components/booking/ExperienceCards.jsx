      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        {selectedBoat && (
          <motion.div 
            ...
            className="mb-12 bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl rounded-3xl p-6 border border-white/20"
          >
            <div className="flex items-start justify-between mb-4">
              <div>
                ...
                <div className="flex gap-2 mb-3">
                  ...
                  <Badge className="bg-purple-500/20 text-purple-300 border-purple-400/30 flex items-center gap-2">
            ...
            <p className="text-white/80 mb-4">{selectedBoat.description}</p>

            <div className="grid md:grid-cols-2 gap-6">
              {selectedBoat.equipment && Object.keys(selectedBoat.equipment).some(key => selectedBoat.equipment[key]) && (
                <div>
                  <h4 className="text-sm font-semibold text-cyan-400 uppercase tracking-wide mb-3">Equipment & Features</h4>
              ...
              <div>
                {selectedBoat.engine_name && (
                  <div className="mb-3">
                    <h4 className="text-sm font-semibold text-cyan-400 uppercase tracking-wide mb-2">Engine</h4>
                    <p className="text-white/80 text-sm">{selectedBoat.engine_name}</p>
                    {selectedBoat.engine_config && (
                      <p className="text-white/60 text-xs mt-1 capitalize">{selectedBoat.engine_config}</p>
                    )}
                  </div>
                )}
                ...
                {selectedBoat.crew_members > 0 && (
                  <div>
                    <h4 className="text-sm font-semibold text-cyan-400 uppercase tracking-wide mb-2">Crew</h4>
                    <p className="text-white/80 text-sm">{selectedBoat.crew_members} crew member{selectedBoat.crew_members > 1 ? 's' : ''}</p>
                  </div>
                )}
              </div>
            </div>
